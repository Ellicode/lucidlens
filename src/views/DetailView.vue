...
import { FlagIcon, InformationCircleIcon } from '@heroicons/vue/16/solid'
...
<template>
  <div class="mx-auto p-5 py-10 xl:py-20 2xl:max-w-7xl">
    ...
    <template v-if="typeof article === 'object' && article !== null">
      ...
      <div class="mb-6 flex max-sm:flex-col sm:items-start">
        <div class="flex-1">
        ...
        <div class="flex h-96 flex-col justify-center sm:ms-20">
          <div
            class="relative h-5 w-70 rounded-full bg-gradient-to-r from-blue-500 via-white to-red-500"
          >
            <div
          ...
          <div v-if="opinions.total > 0" class="mt-2 flex items-center justify-between gap-3">
            <div
              class="h-3 rounded-full bg-blue-500 transition-all duration-500"
              :style="{
                width: `${(opinions.left / opinions.total) * 100}%`,
              }"
            ></div>
          ...
          <div v-if="opinions.total > 0" class="mt-2 flex items-center justify-between gap-3">
            <div
              class="h-3 rounded-full bg-neutral-200 transition-all duration-500"
              :style="{
                width: `${(opinions.neutral / opinions.total) * 100}%`,
              }"
            ></div>
          ...
          <div v-if="opinions.total > 0" class="mt-2 flex items-center justify-between gap-3">
            <div
              ...
              :style="{
                width: `${(opinions.right / opinions.total) * 100}%`,
              }"
            ></div>
          ...
          <div class="mt-5 flex items-center gap-2">
            ...
            <button
              ...
              class="flex-1 cursor-pointer rounded-md py-1.5 font-serif"
              :class="{
                'bg-neutral-300 text-neutral-700': userOpinion === 'neutral',
          ...
          <button
            v-if="userOpinion"
            class="mt-3 cursor-pointer text-neutral-500"
